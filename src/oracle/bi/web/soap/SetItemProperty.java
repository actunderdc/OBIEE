 ...
 *         &lt;element name="lastModified" type="{http://www.w3.org/2001/XMLSchema}dateTime" maxOccurs="unbounded" minOccurs="0"/>
...
public class SetItemProperty {
    ...
    protected List<XMLGregorianCalendar> lastModified;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<XMLGregorianCalendar> getLastModified() {
        if (lastModified == null) {
            lastModified = new ArrayList<XMLGregorianCalendar>();
        }
